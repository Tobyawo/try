            ...
            <div class="row scroll-me" >
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 logo-wrapper">
                    <form action="LoginCheck" method="post">
                        ...
                        <button><input type="submit" class="btn btn-success" value="login"></button>
                        <button type="submit" class="btn text-center"> <a href="#">Forgotten password?</a></button><p></p>
                       <button type="submit" class="btn"> <a href="SignUp.jsp">Create New Account</a></button><p></p>
<%--                        <button type="submit" value="logout" class="btn"> <a href="#">Log Out</a></button><p></p>--%>
<%--                        <button type="submit" class="btn"> <a href="newIndex.jsp">New index page</a></button>--%>
