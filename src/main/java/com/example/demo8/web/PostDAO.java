...
import com.example.demo8.Model.Post;
...
public class PostDAO extends HttpServlet {
    ...
    private static final String INSERT_NEW_POST = "INSERT INTO post  (email,post,sessionId,  creationTime,  lastAccessedTime) VALUES (?, ?,?,?,?)";
...
Date lastAccessedTime = new Date(session.getLastAccessedTime());
        ...
        System.out.println("session attribute email : " + email+ "post = " + post);
        System.out.println(session.getId()+" ,"+ creationTime+ " ,"+ lastAccessedTime+ " , "+post+ "  ," + email);



        Post newPost = new Post(email,post,sessionId,  creationTime,  lastAccessedTime);
    ...
    public void insertComment(Post post){
        System.out.println(INSERT_NEW_POST);
        ...
        try {
            ...
            preparedStatement.setString(3, post.getSessionId());
            preparedStatement.setDate(4, (Date) post.getCreationTime());
            preparedStatement.setDate(5, (Date) post.getLastAccessedTime());
